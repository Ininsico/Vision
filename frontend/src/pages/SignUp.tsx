                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="mt-12 p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-primary-200">
                            ...
                            <a
                                ...
                                className="inline-flex items-center space-x-2 text-peach-600 hover:text-peach-700 font-semibold transition-colors"
                            >
                    ...
                    >
                        ...
                        <p className="mt-6 text-sm text-primary-600 text-center">
                            ...
                            <Link to="/sign-in" className="text-peach-600 hover:text-peach-700 font-semibold">
                                Sign in
                            </Link>
                        </p>
                    </motion.div>
